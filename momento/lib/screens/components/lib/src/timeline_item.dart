      ...
      return Row(
        ...
        children: <Widget>[
          Container(
              ...
              child: icon),
          Container(
              padding: const EdgeInsets.only(left: TimelineBoxDecoration.LINE_GAP),
              constraints:
                  BoxConstraints(minHeight: margin, maxWidth: constraints.maxWidth - margin * 2.0),
              child: model.child),
        ],
      );
    });
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (BuildContext context, BoxConstraints constraints) {
      return Row(
        ...
        children: <Widget>[
          Container(
              padding: const EdgeInsets.only(right: TimelineBoxDecoration.LINE_GAP),
              constraints:
                  BoxConstraints(minHeight: margin, maxWidth: constraints.maxWidth - margin * 2.0),
              child: model.child),
          Container(
