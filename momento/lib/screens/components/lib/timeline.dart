...
import 'package:momento/screens/components/lib/src/timeline_item.dart';
import 'package:momento/screens/components/lib/src/timeline_painter.dart';
import 'package:momento/screens/components/lib/timeline_model.dart';

typedef IndexedTimelineModelBuilder = TimelineModel Function(BuildContext context, int index);
...
class Timeline extends StatelessWidget {
  ...
  Timeline(
      ...
      : itemCount = children.length,
        properties =
            TimelineProperties(lineColor: lineColor, lineWidth: lineWidth, iconSize: iconSize),
